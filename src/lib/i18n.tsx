...
const dictionary = {
  ja: {
    ...
    createSpot: {
      ...
      photosTemplate: '写真（最大{n}枚）',
      photosHelp: '写真は自動的に縮小・圧縮されてからアップロードされます。',
      pickPhotos: '写真を選択',
      embedsTemplate: 'SNS投稿（最大{n}件）',
      embedsHelp:
      ...
      hashtagsTemplate: 'ハッシュタグ（最大{n}個）',
      hashtagsHelp: '雰囲気を表すキーワードを追加すると、検索で見つけてもらいやすくなります。',
  ...
  en: {
    ...
    createSpot: {
      ...
      photosTemplate: 'Photos (up to {n})',
      photosHelp: 'Photos are automatically resized and compressed before uploading.',
      pickPhotos: 'Choose photos',
      embedsTemplate: 'SNS Embeds (up to {n})',
      embedsHelp:
        'If this spot is featured on Instagram or X, add the URL of a related post to embed it on the detail screen.',
      embedPlaceholder: 'https://www.instagram.com/p/... or https://x.com/.../status/...',
      mediaRequiredNote: 'A photo or an SNS embed is required',
      hashtagsTemplate: 'Hashtags (up to {n})',
      hashtagsHelp: 'Adding keywords that describe the mood helps others find this spot through search.',
