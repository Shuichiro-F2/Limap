...
const dictionary = {
  ja: {
    ...
    addReview: {
      headerTitle: 'レビューを投稿',
      leadTemplate: '「{name}」についての投稿を追加します。',
      comment: 'コメント',
      commentPlaceholder: '訪れた感想や気づいたことなど',
      commentHelp: '写真やSNS投稿がなくても、コメントだけの投稿もできます。',
      submit: 'レビューを投稿する',
      submitting: '投稿中…',
      submitSuccessTitle: 'レビューを投稿しました',
      submitFailedTitle: '投稿に失敗しました',
      contentRequiredTitle: '写真・SNS投稿・コメントのいずれかを入力してください',
      spotLoadFailedTitle: '投稿の読み込みに失敗しました',
    },
    duplicateSpot: {
      title: '近くに似た投稿があります',
      lead: '同じ場所への重複投稿を防ぐため、既存の投稿にレビューとして追加することもできます。',
      continueAsNew: 'このまま新規投稿を続ける',
    },
  },
  en: {
    map: {
    ...
    addReview: {
      ...
      leadTemplate: 'Add a post about "{name}".',
      comment: 'Comment',
      commentPlaceholder: 'Your impressions, things you noticed, etc.',
      commentHelp: 'You can post a comment alone, even without photos or an SNS embed.',
      submit: 'Post Review',
      submitting: 'Posting…',
      submitSuccessTitle: 'Review posted',
      submitFailedTitle: 'Failed to post',
      contentRequiredTitle: 'Please add a photo, SNS embed, or comment',
      spotLoadFailedTitle: 'Failed to load post',
    },
    duplicateSpot: {
      title: 'A similar spot already exists nearby',
      lead: "To avoid duplicate posts for the same place, you can add this as a review to the existing post instead.",
