...
export const ABOUT_PAGE: StaticPageContent = {
  ...
  metaDescription:
    'リミナルスペース（限界空間）とは何か、その意味・特徴・日本各地の実例を解説。廃墟や無人駅、深夜の駐車場など、リミナルスペースをLIMapの地図で記録・共有する方法もご紹介します。',
  heading: 'リミナルスペースとは',
...
export const HELP_PAGE: StaticPageContent = {
  ...
  heading: 'LIMapの使い方',
  lead: 'LIMapは、リミナルスペース（限界空間）を写真と場所で記録・共有する地図アプリです。基本的な使い方をご紹介します。',
  sections: [
    {
